...
\pgfplotstableread[col sep = comma]{represents.csv}\mydata
...
\begin{axis}[
    ...
    ylabel={\\Number of lines/rectangles},
    ...
    x tick label style={yshift=0pt,rotate=90,anchor=east,font=\sffamily\small},
    %grid prop
    grid=both,
