...
if debug:
    '''
 [Errno 2] No such file or directory: '../out/tmp/Pslicesegs.pickle'
 [Errno 2] No such file or directory: '../out/tmp/ftCsegs.pickle'
312 1458 2730
002b55101977
(699831809.0, 1931495910.0, 699832655.0, 1931549436.0)
(699831809.0, 1931495910.0)--(699832655.0, 1931549436.0){'bel': u'777', 'isswapped': 1, 'islrordered': True, 'abv': u'777', 'edgeid': u'2410'}
898d629d9b28
    '''
    dodebug()
    print hashargs(699831809, 1931495910, 699832655, 1931549436)
